...
class SimonSamplerResponder:
    """Task-specific Simon sampler responder."""
    ...
    def act(self, obs: Observation) -> Action:
        ...
        if phase in ("instruction_text", "block", "goodbye", "block_feedback"):
            ...
            return Action(key=key, rt_s=max(0.01, self.continue_rt_s), meta={"source": "simon_sampler", "phase": phase})
